...
<div class="container">
    <div class="row mb-2">
        <div class="col-sm-12">
            ...
            <h1 class="card-title"> Dashboard | <span id="subtext-h1-title"><small> showing today's numbers</small>
                </span></h1>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
...
<div class="row">
    <div class="col-md-3 col-6">
        ...
        <div class="small-box bg-info">
            <div class="inner">
                <h3>{{ $total_entries }} <sup style="font-size: 20px">pkts</sup> | <sup style="font-size: 20px">
                        {{ number_format($total_tonnage, 2) }} Kgs</sup></h3>
