...
<div class="row">
	<div class="col-md-4 col-6">
		<div class="small-box bg-info">
			...
			<a href="{{ route('list_issued_idt', ['from_location' => '4450']) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
		</div>
	</div>
	<div class="col-md-4 col-6">
		<div class="small-box bg-success">
			...
			<a href="{{ route('list_receive', ['to_location' => '4450']) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
		</div>
	</div>
	<div class="col-md-4 col-6">
		<div class="small-box bg-warning">
			...
			<a href="{{ route('list_issued_idt', ['from_location' => '4450']) }}" class="small-box-footer">Review <i class="fas fa-arrow-circle-right"></i></a>
		</div>
	</div>
</div>
