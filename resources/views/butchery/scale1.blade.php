...
<div class="container">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0"> {{ $title }} |<small> Beheading pig & sow</small></h1>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
            ...
            <div class="card-body " style="padding-top: 15%">
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="G1030" name="baconers">
                        <label for="form-check-label">Baconers</label>
                    </div> <br> <br>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="G1031" name="sows" checked>
                        <label for="form-check-label">Sows </label>
                    </div>
                </div> <br>
                <div class="form-group" style="padding-left: 20%">
                    <button type="button" onclick="getWeightAjaxApi()" id="weigh" value="COM4" class="btn btn-primary btn-lg">Weigh</button> <br><br>
