                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-toggle="modal" data-target="#approveModal"
                                        class="btn btn-sm btn-primary" data-id="{{ $data->id }}"
                                        data-product="{{ $data->product?? $data->product2?? $data->beef_product }}"
                                        data-weight="{{ $data->total_weight }}" data-pieces="{{ $data->total_pieces }}"
...
<div id="approveModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        <form class="modal-content" id="approval-form" action="{{ route('approve_idt') }}" method="post">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title" id="editIdtModalLabel">Approve Transfer: <strong><input style="border:none"
                            type="text" id="approve_transfer_id" name="id" value="" readonly></strong>
                </h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="" id="approve_net" name="net" required
                                    readonly>
                            </div>
                        </div>
                    </div>
